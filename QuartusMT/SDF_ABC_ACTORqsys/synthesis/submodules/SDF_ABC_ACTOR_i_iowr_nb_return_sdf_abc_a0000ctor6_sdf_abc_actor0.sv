...
// SystemVerilog created from i_iowr_nb_return_sdf_abc_actor_unnamed_sdf_abc_actor6_sdf_abc_actor0
...
module SDF_ABC_ACTOR_i_iowr_nb_return_sdf_abc_a0000ctor6_sdf_abc_actor0 (
    ...
    assign out_iowr_nb_return_SDF_ABC_ACTOR_o_fifodata = iowr_nb_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_nb_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_nb_return_SDF_ABC_ACTOR_o_fifovalid = iowr_nb_o_fifovalid;
