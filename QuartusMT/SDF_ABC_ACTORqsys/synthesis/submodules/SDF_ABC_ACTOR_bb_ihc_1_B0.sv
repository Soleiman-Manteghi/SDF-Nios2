...
module SDF_ABC_ACTOR_bb_ihc_1_B0 (
    ...
    SDF_ABC_ACTOR_ihc_1_B0_merge theihc_1_B0_merge (
    ...
    SDF_ABC_ACTOR_ihc_1_B0_branch theihc_1_B0_branch (
    ...
    SDF_ABC_ACTOR_bb_ihc_1_B0_stall_region thebb_ihc_1_B0_stall_region (
