...
// SystemVerilog created from i_iowr_bl_call_ihc_1_unnamed_sdf_abc_actor101_sdf_abc_actor100
...
module SDF_ABC_ACTOR10_i_iowr_bl_call_ihc_1_unn0000101_sdf_abc_actor100 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_call_ihc_1_i_fifoready;
    ...
    assign out_iowr_bl_call_ihc_1_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_bl_call_ihc_1_o_fifovalid = iowr_o_fifovalid;
