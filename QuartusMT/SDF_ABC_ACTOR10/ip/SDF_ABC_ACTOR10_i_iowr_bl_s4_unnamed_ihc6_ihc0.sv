...
// SystemVerilog created from i_iowr_bl_s4_unnamed_ihc6_ihc0
...
module SDF_ABC_ACTOR10_i_iowr_bl_s4_unnamed_ihc6_ihc0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_s4_1_i_fifoready;
    ...
    assign out_iowr_bl_s4_1_o_fifodata = iowr_o_fifodata;

    // sync_out(GPOUT,9)@20000000
    assign out_o_stall = iowr_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,12)
    assign out_iowr_bl_s4_1_o_fifovalid = iowr_o_fifovalid;
