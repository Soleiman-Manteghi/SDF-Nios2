...
module SDF_ABC_ACTOR10_bb_ihc_B0 (
    ...
    SDF_ABC_ACTOR10_ihc_B0_merge theihc_B0_merge (
    ...
    SDF_ABC_ACTOR10_ihc_B0_branch theihc_B0_branch (
    ...
    SDF_ABC_ACTOR10_bb_ihc_B0_stall_region thebb_ihc_B0_stall_region (
