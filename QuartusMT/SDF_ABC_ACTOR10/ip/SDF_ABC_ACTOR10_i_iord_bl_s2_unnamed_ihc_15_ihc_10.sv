...
// SystemVerilog created from i_iord_bl_s2_unnamed_ihc_15_ihc_10
...
module SDF_ABC_ACTOR10_i_iord_bl_s2_unnamed_ihc_15_ihc_10 (
    ...
    SDF_ABC_ACTOR10_dupName_4_reg_26oi0676j686u0qc0pdz thereg_rsrvd_fix (
    ...
    // iord(EXTIFACE,5)
    assign iord_i_fifodata = in_iord_bl_s2_3_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_s2_3_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_s2_3_i_fifodata),
    ...
    assign out_iord_bl_s2_3_o_fifoalmost_full = iord_o_fifoalmost_full;

    // sync_out(GPOUT,12)@20000000
    assign out_o_stall = iord_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iord_bl_s2_3_o_fifoready = iord_o_fifoready;
