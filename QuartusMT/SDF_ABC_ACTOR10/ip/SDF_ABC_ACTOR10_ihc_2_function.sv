...
module SDF_ABC_ACTOR10_ihc_2_function (
    ...
    SDF_ABC_ACTOR10_i_llvm_fpga_pipeline_kee0000ng_ihc_22_valid_fifo thei_llvm_fpga_pipeline_keep_going_ihc_22_valid_fifo (
    ...
    SDF_ABC_ACTOR10_i_llvm_fpga_pipeline_keep_going_ihc_22_sr thei_llvm_fpga_pipeline_keep_going_ihc_22_sr (
        .in_i_data(GND_q),
    ...
    SDF_ABC_ACTOR10_arbiter_iowr_s2 thearbiter_iowr_s2 (
    ...
    SDF_ABC_ACTOR10_arbiter_iowr_s1 thearbiter_iowr_s1 (
    ...
    SDF_ABC_ACTOR10_bb_ihc_2_B1 thebb_ihc_2_B1 (
        .in_forked_0(GND_q),
    ...
    SDF_ABC_ACTOR10_bb_ihc_2_B0 thebb_ihc_2_B0 (
    ...
    SDF_ABC_ACTOR10_bb_ihc_2_B1_sr_1 thebb_ihc_2_B1_sr_1_aunroll_x (
