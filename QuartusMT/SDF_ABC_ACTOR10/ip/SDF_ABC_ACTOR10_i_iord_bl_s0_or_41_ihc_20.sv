...
// SystemVerilog created from i_iord_bl_s0_or_41_ihc_20
...
module SDF_ABC_ACTOR10_i_iord_bl_s0_or_41_ihc_20 (
    ...
    // iord(EXTIFACE,4)
    assign iord_i_fifodata = in_iord_bl_s0_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_s0_i_fifovalid;
    assign iord_i_predicate = in_c1_exe1;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_s0_i_fifodata),
    ...
    assign out_iord_bl_s0_o_fifoalmost_full = iord_o_fifoalmost_full;

    // sync_out(GPOUT,10)@20000000
    assign out_o_stall = iord_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,12)
    assign out_iord_bl_s0_o_fifoready = iord_o_fifoready;
