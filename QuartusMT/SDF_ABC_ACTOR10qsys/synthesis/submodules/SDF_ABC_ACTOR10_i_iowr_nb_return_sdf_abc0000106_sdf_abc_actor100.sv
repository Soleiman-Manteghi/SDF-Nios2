...
// SystemVerilog created from i_iowr_nb_return_sdf_abc_actor10_unnamed_sdf_abc_actor106_sdf_abc_actor100
...
module SDF_ABC_ACTOR10_i_iowr_nb_return_sdf_abc0000106_sdf_abc_actor100 (
    ...
    // iowr_nb(EXTIFACE,8)
    assign iowr_nb_i_data = element_extension1_q[0:0];
    ...
    assign out_iowr_nb_return_SDF_ABC_ACTOR10_o_fifodata = iowr_nb_o_fifodata;

    // sync_out(GPOUT,11)@20000000
    assign out_o_stall = iowr_nb_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,14)
    assign out_iowr_nb_return_SDF_ABC_ACTOR10_o_fifovalid = iowr_nb_o_fifovalid;
