...
module SDF_ABC_ACTOR10_i_sfc_logic_s_c0_in_whil0000_2s_c0_enter1_ihc_20 (
    ...
    reg [0:0] redist0_sync_together13_aunroll_x_in_c0_eni1_1_tpl_6_q;
    reg [0:0] redist1_sync_together13_aunroll_x_in_i_valid_6_q;
    wire [0:0] enable_stall_connector_not_enable_q;


    // redist1_sync_together13_aunroll_x_in_i_valid_6(DELAY,18)
    dspba_delay_ver #( .width(1), .depth(6), .reset_kind("ASYNC"), .phase(0), .modulus(1), .reset_high(1'b0) )
    redist1_sync_together13_aunroll_x_in_i_valid_6 ( .xin(in_i_valid), .xout(redist1_sync_together13_aunroll_x_in_i_valid_6_q), .ena(in_enable[0]), .clk(clock), .aclr(resetn) );

    // enable_stall_connector_not_enable(LOGICAL,19)
    assign enable_stall_connector_not_enable_q = $unsigned(~ (in_enable));

    // i_llvm_fpga_push_i1_notexitcond_ihc_23(BLACKBOX,10)@7
    // out out_feedback_out_2@20000000
    // out out_feedback_valid_out_2@20000000
    SDF_ABC_ACTOR10_i_llvm_fpga_push_i1_notexitcond_ihc_20 thei_llvm_fpga_push_i1_notexitcond_ihc_23 (
        .in_data_in(VCC_q),
        ...
        .in_valid_in(redist1_sync_together13_aunroll_x_in_i_valid_6_q),
    ...
    // i_llvm_fpga_pipeline_keep_going_ihc_22(BLACKBOX,9)@7
    // out out_exiting_stall_out@20000000
    // out out_exiting_valid_out@20000000
    // out out_initeration_stall_out@20000000
    // out out_not_exitcond_stall_out@20000000
    // out out_pipeline_valid_out@20000000
    SDF_ABC_ACTOR10_i_llvm_fpga_pipeline_keep_going_ihc_20 thei_llvm_fpga_pipeline_keep_going_ihc_22 (
        .in_data_in(VCC_q),
    ...
    // redist0_sync_together13_aunroll_x_in_c0_eni1_1_tpl_6(DELAY,17)
    dspba_delay_ver #( .width(1), .depth(6), .reset_kind("ASYNC"), .phase(0), .modulus(1), .reset_high(1'b0) )
    redist0_sync_together13_aunroll_x_in_c0_eni1_1_tpl_6 ( .xin(in_c0_eni1_1_tpl), .xout(redist0_sync_together13_aunroll_x_in_c0_eni1_1_tpl_6_q), .ena(in_enable[0]), .clk(clock), .aclr(resetn) );
    ...
    assign out_c0_exi2_2_tpl = redist0_sync_together13_aunroll_x_in_c0_eni1_1_tpl_6_q;
    assign out_o_valid = redist1_sync_together13_aunroll_x_in_i_valid_6_q;
