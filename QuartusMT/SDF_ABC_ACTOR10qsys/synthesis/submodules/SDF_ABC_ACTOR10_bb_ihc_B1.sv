...
module SDF_ABC_ACTOR10_bb_ihc_B1 (
    ...
    wire [0:0] bb_ihc_B1_stall_region_out_iord_bl_s1_0_o_fifoalmost_full;
    wire [0:0] bb_ihc_B1_stall_region_out_iord_bl_s1_0_o_fifoready;
    wire [0:0] bb_ihc_B1_stall_region_out_iord_bl_s1_1_o_fifoalmost_full;
    wire [0:0] bb_ihc_B1_stall_region_out_iord_bl_s1_1_o_fifoready;
    wire [0:0] bb_ihc_B1_stall_region_out_iord_bl_s3_o_fifoalmost_full;
    wire [0:0] bb_ihc_B1_stall_region_out_iord_bl_s3_o_fifoready;
    wire [31:0] bb_ihc_B1_stall_region_out_iowr_bl_s4_0_o_fifodata;
    wire [0:0] bb_ihc_B1_stall_region_out_iowr_bl_s4_0_o_fifovalid;
    wire [31:0] bb_ihc_B1_stall_region_out_iowr_bl_s4_1_o_fifodata;
    wire [0:0] bb_ihc_B1_stall_region_out_iowr_bl_s4_1_o_fifovalid;
    ...
    SDF_ABC_ACTOR10_ihc_B1_branch theihc_B1_branch (
    ...
    SDF_ABC_ACTOR10_ihc_B1_merge theihc_B1_merge (
    ...
    SDF_ABC_ACTOR10_bb_ihc_B1_stall_region thebb_ihc_B1_stall_region (
        ...
        .out_iord_bl_s1_0_o_fifoalmost_full(bb_ihc_B1_stall_region_out_iord_bl_s1_0_o_fifoalmost_full),
        .out_iord_bl_s1_0_o_fifoready(bb_ihc_B1_stall_region_out_iord_bl_s1_0_o_fifoready),
        .out_iord_bl_s1_1_o_fifoalmost_full(bb_ihc_B1_stall_region_out_iord_bl_s1_1_o_fifoalmost_full),
        .out_iord_bl_s1_1_o_fifoready(bb_ihc_B1_stall_region_out_iord_bl_s1_1_o_fifoready),
        .out_iord_bl_s3_o_fifoalmost_full(bb_ihc_B1_stall_region_out_iord_bl_s3_o_fifoalmost_full),
        .out_iord_bl_s3_o_fifoready(bb_ihc_B1_stall_region_out_iord_bl_s3_o_fifoready),
        .out_iowr_bl_s4_0_o_fifodata(bb_ihc_B1_stall_region_out_iowr_bl_s4_0_o_fifodata),
        .out_iowr_bl_s4_0_o_fifovalid(bb_ihc_B1_stall_region_out_iowr_bl_s4_0_o_fifovalid),
        .out_iowr_bl_s4_1_o_fifodata(bb_ihc_B1_stall_region_out_iowr_bl_s4_1_o_fifodata),
        .out_iowr_bl_s4_1_o_fifovalid(bb_ihc_B1_stall_region_out_iowr_bl_s4_1_o_fifovalid),
    ...
    // out_iord_bl_s1_0_o_fifoalmost_full(GPOUT,20)
    assign out_iord_bl_s1_0_o_fifoalmost_full = bb_ihc_B1_stall_region_out_iord_bl_s1_0_o_fifoalmost_full;

    // out_iord_bl_s1_0_o_fifoready(GPOUT,21)
    assign out_iord_bl_s1_0_o_fifoready = bb_ihc_B1_stall_region_out_iord_bl_s1_0_o_fifoready;

    // out_iord_bl_s1_1_o_fifoalmost_full(GPOUT,22)
    assign out_iord_bl_s1_1_o_fifoalmost_full = bb_ihc_B1_stall_region_out_iord_bl_s1_1_o_fifoalmost_full;

    // out_iord_bl_s1_1_o_fifoready(GPOUT,23)
    assign out_iord_bl_s1_1_o_fifoready = bb_ihc_B1_stall_region_out_iord_bl_s1_1_o_fifoready;

    // out_iord_bl_s3_o_fifoalmost_full(GPOUT,24)
    assign out_iord_bl_s3_o_fifoalmost_full = bb_ihc_B1_stall_region_out_iord_bl_s3_o_fifoalmost_full;

    // out_iord_bl_s3_o_fifoready(GPOUT,25)
    assign out_iord_bl_s3_o_fifoready = bb_ihc_B1_stall_region_out_iord_bl_s3_o_fifoready;

    // out_iowr_bl_s4_0_o_fifodata(GPOUT,26)
    assign out_iowr_bl_s4_0_o_fifodata = bb_ihc_B1_stall_region_out_iowr_bl_s4_0_o_fifodata;

    // out_iowr_bl_s4_0_o_fifovalid(GPOUT,27)
    assign out_iowr_bl_s4_0_o_fifovalid = bb_ihc_B1_stall_region_out_iowr_bl_s4_0_o_fifovalid;

    // out_iowr_bl_s4_1_o_fifodata(GPOUT,28)
    assign out_iowr_bl_s4_1_o_fifodata = bb_ihc_B1_stall_region_out_iowr_bl_s4_1_o_fifodata;

    // out_iowr_bl_s4_1_o_fifovalid(GPOUT,29)
    assign out_iowr_bl_s4_1_o_fifovalid = bb_ihc_B1_stall_region_out_iowr_bl_s4_1_o_fifovalid;
