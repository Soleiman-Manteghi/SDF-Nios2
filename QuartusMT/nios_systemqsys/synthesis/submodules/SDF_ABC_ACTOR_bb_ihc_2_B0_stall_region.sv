...
module SDF_ABC_ACTOR_bb_ihc_2_B0_stall_region (
    ...
    // out out_valid_out@2
    SDF_ABC_ACTOR_i_llvm_fpga_push_token_i1_wt_limpush_ihc_20 thei_llvm_fpga_push_token_i1_wt_limpush_ihc_21 (
        .in_data_in(GND_q),
    ...
    // out out_stall_out@20000000
    // out out_valid_out@1
    SDF_ABC_ACTOR_ihc_2_B0_merge_reg theihc_2_B0_merge_reg (
        .in_data_in(GND_q),
