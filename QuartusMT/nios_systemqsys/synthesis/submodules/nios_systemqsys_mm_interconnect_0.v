// nios_systemqsys_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module nios_systemqsys_mm_interconnect_0 (
		...
		output wire [0:0]  nios_output_in_address,                         //                           nios_output_in.address
		output wire        nios_output_in_write,                           //                                         .write
		output wire [31:0] nios_output_in_writedata,                       //                                         .writedata
		input  wire        nios_output_in_waitrequest,                     //                                         .waitrequest
		output wire [2:0]  nios_output_in_csr_address,                     //                       nios_output_in_csr.address
		output wire        nios_output_in_csr_write,                       //                                         .write
		output wire        nios_output_in_csr_read,                        //                                         .read
		input  wire [31:0] nios_output_in_csr_readdata,                    //                                         .readdata
		output wire [31:0] nios_output_in_csr_writedata,                   //                                         .writedata
		output wire [2:0]  niose_input_in_csr_address,                     //                       niose_input_in_csr.address
		output wire        niose_input_in_csr_write,                       //                                         .write
		output wire        niose_input_in_csr_read,                        //                                         .read
		input  wire [31:0] niose_input_in_csr_readdata,                    //                                         .readdata
		output wire [31:0] niose_input_in_csr_writedata,                   //                                         .writedata
		output wire [0:0]  niose_input_out_address,                        //                          niose_input_out.address
		output wire        niose_input_out_read,                           //                                         .read
		input  wire [31:0] niose_input_out_readdata,                       //                                         .readdata
		input  wire        niose_input_out_waitrequest,                    //                                         .waitrequest
	...
	wire  [31:0] nios_output_in_agent_m0_readdata;                                                   // nios_output_in_translator:uav_readdata -> nios_output_in_agent:m0_readdata
	wire         nios_output_in_agent_m0_waitrequest;                                                // nios_output_in_translator:uav_waitrequest -> nios_output_in_agent:m0_waitrequest
	wire         nios_output_in_agent_m0_debugaccess;                                                // nios_output_in_agent:m0_debugaccess -> nios_output_in_translator:uav_debugaccess
	wire  [18:0] nios_output_in_agent_m0_address;                                                    // nios_output_in_agent:m0_address -> nios_output_in_translator:uav_address
	wire   [3:0] nios_output_in_agent_m0_byteenable;                                                 // nios_output_in_agent:m0_byteenable -> nios_output_in_translator:uav_byteenable
	wire         nios_output_in_agent_m0_read;                                                       // nios_output_in_agent:m0_read -> nios_output_in_translator:uav_read
	wire         nios_output_in_agent_m0_readdatavalid;                                              // nios_output_in_translator:uav_readdatavalid -> nios_output_in_agent:m0_readdatavalid
	wire         nios_output_in_agent_m0_lock;                                                       // nios_output_in_agent:m0_lock -> nios_output_in_translator:uav_lock
	wire  [31:0] nios_output_in_agent_m0_writedata;                                                  // nios_output_in_agent:m0_writedata -> nios_output_in_translator:uav_writedata
	wire         nios_output_in_agent_m0_write;                                                      // nios_output_in_agent:m0_write -> nios_output_in_translator:uav_write
	wire   [2:0] nios_output_in_agent_m0_burstcount;                                                 // nios_output_in_agent:m0_burstcount -> nios_output_in_translator:uav_burstcount
	wire         nios_output_in_agent_rf_source_valid;                                               // nios_output_in_agent:rf_source_valid -> nios_output_in_agent_rsp_fifo:in_valid
	wire  [95:0] nios_output_in_agent_rf_source_data;                                                // nios_output_in_agent:rf_source_data -> nios_output_in_agent_rsp_fifo:in_data
	wire         nios_output_in_agent_rf_source_ready;                                               // nios_output_in_agent_rsp_fifo:in_ready -> nios_output_in_agent:rf_source_ready
	wire         nios_output_in_agent_rf_source_startofpacket;                                       // nios_output_in_agent:rf_source_startofpacket -> nios_output_in_agent_rsp_fifo:in_startofpacket
	wire         nios_output_in_agent_rf_source_endofpacket;                                         // nios_output_in_agent:rf_source_endofpacket -> nios_output_in_agent_rsp_fifo:in_endofpacket
	wire         nios_output_in_agent_rsp_fifo_out_valid;                                            // nios_output_in_agent_rsp_fifo:out_valid -> nios_output_in_agent:rf_sink_valid
	wire  [95:0] nios_output_in_agent_rsp_fifo_out_data;                                             // nios_output_in_agent_rsp_fifo:out_data -> nios_output_in_agent:rf_sink_data
	wire         nios_output_in_agent_rsp_fifo_out_ready;                                            // nios_output_in_agent:rf_sink_ready -> nios_output_in_agent_rsp_fifo:out_ready
	wire         nios_output_in_agent_rsp_fifo_out_startofpacket;                                    // nios_output_in_agent_rsp_fifo:out_startofpacket -> nios_output_in_agent:rf_sink_startofpacket
	wire         nios_output_in_agent_rsp_fifo_out_endofpacket;                                      // nios_output_in_agent_rsp_fifo:out_endofpacket -> nios_output_in_agent:rf_sink_endofpacket
	wire         cmd_mux_002_src_valid;                                                              // cmd_mux_002:src_valid -> nios_output_in_agent:cp_valid
	wire  [94:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> nios_output_in_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                              // nios_output_in_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [6:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> nios_output_in_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                                      // cmd_mux_002:src_startofpacket -> nios_output_in_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                        // cmd_mux_002:src_endofpacket -> nios_output_in_agent:cp_endofpacket
	wire  [31:0] nios_output_in_csr_agent_m0_readdata;                                               // nios_output_in_csr_translator:uav_readdata -> nios_output_in_csr_agent:m0_readdata
	wire         nios_output_in_csr_agent_m0_waitrequest;                                            // nios_output_in_csr_translator:uav_waitrequest -> nios_output_in_csr_agent:m0_waitrequest
	wire         nios_output_in_csr_agent_m0_debugaccess;                                            // nios_output_in_csr_agent:m0_debugaccess -> nios_output_in_csr_translator:uav_debugaccess
	wire  [18:0] nios_output_in_csr_agent_m0_address;                                                // nios_output_in_csr_agent:m0_address -> nios_output_in_csr_translator:uav_address
	wire   [3:0] nios_output_in_csr_agent_m0_byteenable;                                             // nios_output_in_csr_agent:m0_byteenable -> nios_output_in_csr_translator:uav_byteenable
	wire         nios_output_in_csr_agent_m0_read;                                                   // nios_output_in_csr_agent:m0_read -> nios_output_in_csr_translator:uav_read
	wire         nios_output_in_csr_agent_m0_readdatavalid;                                          // nios_output_in_csr_translator:uav_readdatavalid -> nios_output_in_csr_agent:m0_readdatavalid
	wire         nios_output_in_csr_agent_m0_lock;                                                   // nios_output_in_csr_agent:m0_lock -> nios_output_in_csr_translator:uav_lock
	wire  [31:0] nios_output_in_csr_agent_m0_writedata;                                              // nios_output_in_csr_agent:m0_writedata -> nios_output_in_csr_translator:uav_writedata
	wire         nios_output_in_csr_agent_m0_write;                                                  // nios_output_in_csr_agent:m0_write -> nios_output_in_csr_translator:uav_write
	wire   [2:0] nios_output_in_csr_agent_m0_burstcount;                                             // nios_output_in_csr_agent:m0_burstcount -> nios_output_in_csr_translator:uav_burstcount
	wire         nios_output_in_csr_agent_rf_source_valid;                                           // nios_output_in_csr_agent:rf_source_valid -> nios_output_in_csr_agent_rsp_fifo:in_valid
	wire  [95:0] nios_output_in_csr_agent_rf_source_data;                                            // nios_output_in_csr_agent:rf_source_data -> nios_output_in_csr_agent_rsp_fifo:in_data
	wire         nios_output_in_csr_agent_rf_source_ready;                                           // nios_output_in_csr_agent_rsp_fifo:in_ready -> nios_output_in_csr_agent:rf_source_ready
	wire         nios_output_in_csr_agent_rf_source_startofpacket;                                   // nios_output_in_csr_agent:rf_source_startofpacket -> nios_output_in_csr_agent_rsp_fifo:in_startofpacket
	wire         nios_output_in_csr_agent_rf_source_endofpacket;                                     // nios_output_in_csr_agent:rf_source_endofpacket -> nios_output_in_csr_agent_rsp_fifo:in_endofpacket
	wire         nios_output_in_csr_agent_rsp_fifo_out_valid;                                        // nios_output_in_csr_agent_rsp_fifo:out_valid -> nios_output_in_csr_agent:rf_sink_valid
	wire  [95:0] nios_output_in_csr_agent_rsp_fifo_out_data;                                         // nios_output_in_csr_agent_rsp_fifo:out_data -> nios_output_in_csr_agent:rf_sink_data
	wire         nios_output_in_csr_agent_rsp_fifo_out_ready;                                        // nios_output_in_csr_agent:rf_sink_ready -> nios_output_in_csr_agent_rsp_fifo:out_ready
	wire         nios_output_in_csr_agent_rsp_fifo_out_startofpacket;                                // nios_output_in_csr_agent_rsp_fifo:out_startofpacket -> nios_output_in_csr_agent:rf_sink_startofpacket
	wire         nios_output_in_csr_agent_rsp_fifo_out_endofpacket;                                  // nios_output_in_csr_agent_rsp_fifo:out_endofpacket -> nios_output_in_csr_agent:rf_sink_endofpacket
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> nios_output_in_csr_agent:cp_valid
	wire  [94:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> nios_output_in_csr_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // nios_output_in_csr_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [6:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> nios_output_in_csr_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> nios_output_in_csr_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> nios_output_in_csr_agent:cp_endofpacket
	wire  [31:0] niose_input_in_csr_agent_m0_readdata;                                               // niose_input_in_csr_translator:uav_readdata -> niose_input_in_csr_agent:m0_readdata
	wire         niose_input_in_csr_agent_m0_waitrequest;                                            // niose_input_in_csr_translator:uav_waitrequest -> niose_input_in_csr_agent:m0_waitrequest
	wire         niose_input_in_csr_agent_m0_debugaccess;                                            // niose_input_in_csr_agent:m0_debugaccess -> niose_input_in_csr_translator:uav_debugaccess
	wire  [18:0] niose_input_in_csr_agent_m0_address;                                                // niose_input_in_csr_agent:m0_address -> niose_input_in_csr_translator:uav_address
	wire   [3:0] niose_input_in_csr_agent_m0_byteenable;                                             // niose_input_in_csr_agent:m0_byteenable -> niose_input_in_csr_translator:uav_byteenable
	wire         niose_input_in_csr_agent_m0_read;                                                   // niose_input_in_csr_agent:m0_read -> niose_input_in_csr_translator:uav_read
	wire         niose_input_in_csr_agent_m0_readdatavalid;                                          // niose_input_in_csr_translator:uav_readdatavalid -> niose_input_in_csr_agent:m0_readdatavalid
	wire         niose_input_in_csr_agent_m0_lock;                                                   // niose_input_in_csr_agent:m0_lock -> niose_input_in_csr_translator:uav_lock
	wire  [31:0] niose_input_in_csr_agent_m0_writedata;                                              // niose_input_in_csr_agent:m0_writedata -> niose_input_in_csr_translator:uav_writedata
	wire         niose_input_in_csr_agent_m0_write;                                                  // niose_input_in_csr_agent:m0_write -> niose_input_in_csr_translator:uav_write
	wire   [2:0] niose_input_in_csr_agent_m0_burstcount;                                             // niose_input_in_csr_agent:m0_burstcount -> niose_input_in_csr_translator:uav_burstcount
	wire         niose_input_in_csr_agent_rf_source_valid;                                           // niose_input_in_csr_agent:rf_source_valid -> niose_input_in_csr_agent_rsp_fifo:in_valid
	wire  [95:0] niose_input_in_csr_agent_rf_source_data;                                            // niose_input_in_csr_agent:rf_source_data -> niose_input_in_csr_agent_rsp_fifo:in_data
	wire         niose_input_in_csr_agent_rf_source_ready;                                           // niose_input_in_csr_agent_rsp_fifo:in_ready -> niose_input_in_csr_agent:rf_source_ready
	wire         niose_input_in_csr_agent_rf_source_startofpacket;                                   // niose_input_in_csr_agent:rf_source_startofpacket -> niose_input_in_csr_agent_rsp_fifo:in_startofpacket
	wire         niose_input_in_csr_agent_rf_source_endofpacket;                                     // niose_input_in_csr_agent:rf_source_endofpacket -> niose_input_in_csr_agent_rsp_fifo:in_endofpacket
	wire         niose_input_in_csr_agent_rsp_fifo_out_valid;                                        // niose_input_in_csr_agent_rsp_fifo:out_valid -> niose_input_in_csr_agent:rf_sink_valid
	wire  [95:0] niose_input_in_csr_agent_rsp_fifo_out_data;                                         // niose_input_in_csr_agent_rsp_fifo:out_data -> niose_input_in_csr_agent:rf_sink_data
	wire         niose_input_in_csr_agent_rsp_fifo_out_ready;                                        // niose_input_in_csr_agent:rf_sink_ready -> niose_input_in_csr_agent_rsp_fifo:out_ready
	wire         niose_input_in_csr_agent_rsp_fifo_out_startofpacket;                                // niose_input_in_csr_agent_rsp_fifo:out_startofpacket -> niose_input_in_csr_agent:rf_sink_startofpacket
	wire         niose_input_in_csr_agent_rsp_fifo_out_endofpacket;                                  // niose_input_in_csr_agent_rsp_fifo:out_endofpacket -> niose_input_in_csr_agent:rf_sink_endofpacket
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> niose_input_in_csr_agent:cp_valid
	wire  [94:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> niose_input_in_csr_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // niose_input_in_csr_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> niose_input_in_csr_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> niose_input_in_csr_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> niose_input_in_csr_agent:cp_endofpacket
	wire  [31:0] niose_input_out_agent_m0_readdata;                                                  // niose_input_out_translator:uav_readdata -> niose_input_out_agent:m0_readdata
	wire         niose_input_out_agent_m0_waitrequest;                                               // niose_input_out_translator:uav_waitrequest -> niose_input_out_agent:m0_waitrequest
	wire         niose_input_out_agent_m0_debugaccess;                                               // niose_input_out_agent:m0_debugaccess -> niose_input_out_translator:uav_debugaccess
	wire  [18:0] niose_input_out_agent_m0_address;                                                   // niose_input_out_agent:m0_address -> niose_input_out_translator:uav_address
	wire   [3:0] niose_input_out_agent_m0_byteenable;                                                // niose_input_out_agent:m0_byteenable -> niose_input_out_translator:uav_byteenable
	wire         niose_input_out_agent_m0_read;                                                      // niose_input_out_agent:m0_read -> niose_input_out_translator:uav_read
	wire         niose_input_out_agent_m0_readdatavalid;                                             // niose_input_out_translator:uav_readdatavalid -> niose_input_out_agent:m0_readdatavalid
	wire         niose_input_out_agent_m0_lock;                                                      // niose_input_out_agent:m0_lock -> niose_input_out_translator:uav_lock
	wire  [31:0] niose_input_out_agent_m0_writedata;                                                 // niose_input_out_agent:m0_writedata -> niose_input_out_translator:uav_writedata
	wire         niose_input_out_agent_m0_write;                                                     // niose_input_out_agent:m0_write -> niose_input_out_translator:uav_write
	wire   [2:0] niose_input_out_agent_m0_burstcount;                                                // niose_input_out_agent:m0_burstcount -> niose_input_out_translator:uav_burstcount
	wire         niose_input_out_agent_rf_source_valid;                                              // niose_input_out_agent:rf_source_valid -> niose_input_out_agent_rsp_fifo:in_valid
	wire  [95:0] niose_input_out_agent_rf_source_data;                                               // niose_input_out_agent:rf_source_data -> niose_input_out_agent_rsp_fifo:in_data
	wire         niose_input_out_agent_rf_source_ready;                                              // niose_input_out_agent_rsp_fifo:in_ready -> niose_input_out_agent:rf_source_ready
	wire         niose_input_out_agent_rf_source_startofpacket;                                      // niose_input_out_agent:rf_source_startofpacket -> niose_input_out_agent_rsp_fifo:in_startofpacket
	wire         niose_input_out_agent_rf_source_endofpacket;                                        // niose_input_out_agent:rf_source_endofpacket -> niose_input_out_agent_rsp_fifo:in_endofpacket
	wire         niose_input_out_agent_rsp_fifo_out_valid;                                           // niose_input_out_agent_rsp_fifo:out_valid -> niose_input_out_agent:rf_sink_valid
	wire  [95:0] niose_input_out_agent_rsp_fifo_out_data;                                            // niose_input_out_agent_rsp_fifo:out_data -> niose_input_out_agent:rf_sink_data
	wire         niose_input_out_agent_rsp_fifo_out_ready;                                           // niose_input_out_agent:rf_sink_ready -> niose_input_out_agent_rsp_fifo:out_ready
	wire         niose_input_out_agent_rsp_fifo_out_startofpacket;                                   // niose_input_out_agent_rsp_fifo:out_startofpacket -> niose_input_out_agent:rf_sink_startofpacket
	wire         niose_input_out_agent_rsp_fifo_out_endofpacket;                                     // niose_input_out_agent_rsp_fifo:out_endofpacket -> niose_input_out_agent:rf_sink_endofpacket
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> niose_input_out_agent:cp_valid
	wire  [94:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> niose_input_out_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // niose_input_out_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> niose_input_out_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> niose_input_out_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> niose_input_out_agent:cp_endofpacket
	...
	wire         nios_output_in_agent_rp_valid;                                                      // nios_output_in_agent:rp_valid -> router_004:sink_valid
	wire  [94:0] nios_output_in_agent_rp_data;                                                       // nios_output_in_agent:rp_data -> router_004:sink_data
	wire         nios_output_in_agent_rp_ready;                                                      // router_004:sink_ready -> nios_output_in_agent:rp_ready
	wire         nios_output_in_agent_rp_startofpacket;                                              // nios_output_in_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         nios_output_in_agent_rp_endofpacket;                                                // nios_output_in_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire         nios_output_in_csr_agent_rp_valid;                                                  // nios_output_in_csr_agent:rp_valid -> router_005:sink_valid
	wire  [94:0] nios_output_in_csr_agent_rp_data;                                                   // nios_output_in_csr_agent:rp_data -> router_005:sink_data
	wire         nios_output_in_csr_agent_rp_ready;                                                  // router_005:sink_ready -> nios_output_in_csr_agent:rp_ready
	wire         nios_output_in_csr_agent_rp_startofpacket;                                          // nios_output_in_csr_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         nios_output_in_csr_agent_rp_endofpacket;                                            // nios_output_in_csr_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         niose_input_in_csr_agent_rp_valid;                                                  // niose_input_in_csr_agent:rp_valid -> router_006:sink_valid
	wire  [94:0] niose_input_in_csr_agent_rp_data;                                                   // niose_input_in_csr_agent:rp_data -> router_006:sink_data
	wire         niose_input_in_csr_agent_rp_ready;                                                  // router_006:sink_ready -> niose_input_in_csr_agent:rp_ready
	wire         niose_input_in_csr_agent_rp_startofpacket;                                          // niose_input_in_csr_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         niose_input_in_csr_agent_rp_endofpacket;                                            // niose_input_in_csr_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         niose_input_out_agent_rp_valid;                                                     // niose_input_out_agent:rp_valid -> router_007:sink_valid
	wire  [94:0] niose_input_out_agent_rp_data;                                                      // niose_input_out_agent:rp_data -> router_007:sink_data
	wire         niose_input_out_agent_rp_ready;                                                     // router_007:sink_ready -> niose_input_out_agent:rp_ready
	wire         niose_input_out_agent_rp_startofpacket;                                             // niose_input_out_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         niose_input_out_agent_rp_endofpacket;                                               // niose_input_out_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         nios_output_in_agent_rdata_fifo_src_valid;                                          // nios_output_in_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] nios_output_in_agent_rdata_fifo_src_data;                                           // nios_output_in_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         nios_output_in_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_002:in_0_ready -> nios_output_in_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                                  // avalon_st_adapter_002:out_0_valid -> nios_output_in_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                                   // avalon_st_adapter_002:out_0_data -> nios_output_in_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                                  // nios_output_in_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                                  // avalon_st_adapter_002:out_0_error -> nios_output_in_agent:rdata_fifo_sink_error
	wire         nios_output_in_csr_agent_rdata_fifo_src_valid;                                      // nios_output_in_csr_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] nios_output_in_csr_agent_rdata_fifo_src_data;                                       // nios_output_in_csr_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         nios_output_in_csr_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_003:in_0_ready -> nios_output_in_csr_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> nios_output_in_csr_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> nios_output_in_csr_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                  // nios_output_in_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> nios_output_in_csr_agent:rdata_fifo_sink_error
	wire         niose_input_in_csr_agent_rdata_fifo_src_valid;                                      // niose_input_in_csr_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] niose_input_in_csr_agent_rdata_fifo_src_data;                                       // niose_input_in_csr_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         niose_input_in_csr_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_004:in_0_ready -> niose_input_in_csr_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> niose_input_in_csr_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> niose_input_in_csr_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // niose_input_in_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> niose_input_in_csr_agent:rdata_fifo_sink_error
	wire         niose_input_out_agent_rdata_fifo_src_valid;                                         // niose_input_out_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] niose_input_out_agent_rdata_fifo_src_data;                                          // niose_input_out_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         niose_input_out_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_005:in_0_ready -> niose_input_out_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> niose_input_out_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> niose_input_out_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                                  // niose_input_out_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> niose_input_out_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) nios_output_in_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (nios_output_in_agent_m0_address),                // avalon_universal_slave_0.address
		.uav_burstcount         (nios_output_in_agent_m0_burstcount),             //                         .burstcount
		.uav_read               (nios_output_in_agent_m0_read),                   //                         .read
		.uav_write              (nios_output_in_agent_m0_write),                  //                         .write
		.uav_waitrequest        (nios_output_in_agent_m0_waitrequest),            //                         .waitrequest
		.uav_readdatavalid      (nios_output_in_agent_m0_readdatavalid),          //                         .readdatavalid
		.uav_byteenable         (nios_output_in_agent_m0_byteenable),             //                         .byteenable
		.uav_readdata           (nios_output_in_agent_m0_readdata),               //                         .readdata
		.uav_writedata          (nios_output_in_agent_m0_writedata),              //                         .writedata
		.uav_lock               (nios_output_in_agent_m0_lock),                   //                         .lock
		.uav_debugaccess        (nios_output_in_agent_m0_debugaccess),            //                         .debugaccess
		.av_address             (nios_output_in_address),                         //      avalon_anti_slave_0.address
		.av_write               (nios_output_in_write),                           //                         .write
		.av_writedata           (nios_output_in_writedata),                       //                         .writedata
		.av_waitrequest         (nios_output_in_waitrequest),                     //                         .waitrequest
		.av_read                (),                                               //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) nios_output_in_csr_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (nios_output_in_csr_agent_m0_address),            // avalon_universal_slave_0.address
		.uav_burstcount         (nios_output_in_csr_agent_m0_burstcount),         //                         .burstcount
		.uav_read               (nios_output_in_csr_agent_m0_read),               //                         .read
		.uav_write              (nios_output_in_csr_agent_m0_write),              //                         .write
		.uav_waitrequest        (nios_output_in_csr_agent_m0_waitrequest),        //                         .waitrequest
		.uav_readdatavalid      (nios_output_in_csr_agent_m0_readdatavalid),      //                         .readdatavalid
		.uav_byteenable         (nios_output_in_csr_agent_m0_byteenable),         //                         .byteenable
		.uav_readdata           (nios_output_in_csr_agent_m0_readdata),           //                         .readdata
		.uav_writedata          (nios_output_in_csr_agent_m0_writedata),          //                         .writedata
		.uav_lock               (nios_output_in_csr_agent_m0_lock),               //                         .lock
		.uav_debugaccess        (nios_output_in_csr_agent_m0_debugaccess),        //                         .debugaccess
		.av_address             (nios_output_in_csr_address),                     //      avalon_anti_slave_0.address
		.av_write               (nios_output_in_csr_write),                       //                         .write
		.av_read                (nios_output_in_csr_read),                        //                         .read
		.av_readdata            (nios_output_in_csr_readdata),                    //                         .readdata
		.av_writedata           (nios_output_in_csr_writedata),                   //                         .writedata
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
		.av_byteenable          (),                                               //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) niose_input_in_csr_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (niose_input_in_csr_agent_m0_address),            // avalon_universal_slave_0.address
		.uav_burstcount         (niose_input_in_csr_agent_m0_burstcount),         //                         .burstcount
		.uav_read               (niose_input_in_csr_agent_m0_read),               //                         .read
		.uav_write              (niose_input_in_csr_agent_m0_write),              //                         .write
		.uav_waitrequest        (niose_input_in_csr_agent_m0_waitrequest),        //                         .waitrequest
		.uav_readdatavalid      (niose_input_in_csr_agent_m0_readdatavalid),      //                         .readdatavalid
		.uav_byteenable         (niose_input_in_csr_agent_m0_byteenable),         //                         .byteenable
		.uav_readdata           (niose_input_in_csr_agent_m0_readdata),           //                         .readdata
		.uav_writedata          (niose_input_in_csr_agent_m0_writedata),          //                         .writedata
		.uav_lock               (niose_input_in_csr_agent_m0_lock),               //                         .lock
		.uav_debugaccess        (niose_input_in_csr_agent_m0_debugaccess),        //                         .debugaccess
		.av_address             (niose_input_in_csr_address),                     //      avalon_anti_slave_0.address
		.av_write               (niose_input_in_csr_write),                       //                         .write
		.av_read                (niose_input_in_csr_read),                        //                         .read
		.av_readdata            (niose_input_in_csr_readdata),                    //                         .readdata
		.av_writedata           (niose_input_in_csr_writedata),                   //                         .writedata
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
		.av_byteenable          (),                                               //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) niose_input_out_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (niose_input_out_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (niose_input_out_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (niose_input_out_agent_m0_read),                  //                         .read
		.uav_write              (niose_input_out_agent_m0_write),                 //                         .write
		.uav_waitrequest        (niose_input_out_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (niose_input_out_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (niose_input_out_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (niose_input_out_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (niose_input_out_agent_m0_writedata),             //                         .writedata
		.uav_lock               (niose_input_out_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (niose_input_out_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (niose_input_out_address),                        //      avalon_anti_slave_0.address
		.av_read                (niose_input_out_read),                           //                         .read
		.av_readdata            (niose_input_out_readdata),                       //                         .readdata
		.av_waitrequest         (niose_input_out_waitrequest),                    //                         .waitrequest
		.av_write               (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) nios_output_in_agent (
		.clk                     (clk_0_clk_clk),                                   //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset),  //       clk_reset.reset
		.m0_address              (nios_output_in_agent_m0_address),                 //              m0.address
		.m0_burstcount           (nios_output_in_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (nios_output_in_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (nios_output_in_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (nios_output_in_agent_m0_lock),                    //                .lock
		.m0_readdata             (nios_output_in_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (nios_output_in_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (nios_output_in_agent_m0_read),                    //                .read
		.m0_waitrequest          (nios_output_in_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (nios_output_in_agent_m0_writedata),               //                .writedata
		.m0_write                (nios_output_in_agent_m0_write),                   //                .write
		.rp_endofpacket          (nios_output_in_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (nios_output_in_agent_rp_ready),                   //                .ready
		.rp_valid                (nios_output_in_agent_rp_valid),                   //                .valid
		.rp_data                 (nios_output_in_agent_rp_data),                    //                .data
		.rp_startofpacket        (nios_output_in_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (nios_output_in_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (nios_output_in_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (nios_output_in_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (nios_output_in_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (nios_output_in_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (nios_output_in_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (nios_output_in_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (nios_output_in_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (nios_output_in_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (nios_output_in_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_002_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_002_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_002_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_002_out_0_error),               //                .error
		.rdata_fifo_src_ready    (nios_output_in_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (nios_output_in_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (nios_output_in_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) nios_output_in_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                   //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
		.in_data           (nios_output_in_agent_rf_source_data),             //        in.data
		.in_valid          (nios_output_in_agent_rf_source_valid),            //          .valid
		.in_ready          (nios_output_in_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (nios_output_in_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (nios_output_in_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (nios_output_in_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (nios_output_in_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (nios_output_in_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (nios_output_in_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (nios_output_in_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                           // (terminated)
		.csr_read          (1'b0),                                            // (terminated)
		.csr_write         (1'b0),                                            // (terminated)
		.csr_readdata      (),                                                // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) nios_output_in_csr_agent (
		.clk                     (clk_0_clk_clk),                                       //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
		.m0_address              (nios_output_in_csr_agent_m0_address),                 //              m0.address
		.m0_burstcount           (nios_output_in_csr_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (nios_output_in_csr_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (nios_output_in_csr_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (nios_output_in_csr_agent_m0_lock),                    //                .lock
		.m0_readdata             (nios_output_in_csr_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (nios_output_in_csr_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (nios_output_in_csr_agent_m0_read),                    //                .read
		.m0_waitrequest          (nios_output_in_csr_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (nios_output_in_csr_agent_m0_writedata),               //                .writedata
		.m0_write                (nios_output_in_csr_agent_m0_write),                   //                .write
		.rp_endofpacket          (nios_output_in_csr_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (nios_output_in_csr_agent_rp_ready),                   //                .ready
		.rp_valid                (nios_output_in_csr_agent_rp_valid),                   //                .valid
		.rp_data                 (nios_output_in_csr_agent_rp_data),                    //                .data
		.rp_startofpacket        (nios_output_in_csr_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (nios_output_in_csr_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (nios_output_in_csr_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (nios_output_in_csr_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (nios_output_in_csr_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (nios_output_in_csr_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (nios_output_in_csr_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (nios_output_in_csr_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (nios_output_in_csr_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (nios_output_in_csr_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (nios_output_in_csr_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (nios_output_in_csr_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (nios_output_in_csr_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (nios_output_in_csr_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) nios_output_in_csr_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                       //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.in_data           (nios_output_in_csr_agent_rf_source_data),             //        in.data
		.in_valid          (nios_output_in_csr_agent_rf_source_valid),            //          .valid
		.in_ready          (nios_output_in_csr_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (nios_output_in_csr_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (nios_output_in_csr_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (nios_output_in_csr_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (nios_output_in_csr_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (nios_output_in_csr_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (nios_output_in_csr_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (nios_output_in_csr_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) niose_input_in_csr_agent (
		.clk                     (clk_0_clk_clk),                                       //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
		.m0_address              (niose_input_in_csr_agent_m0_address),                 //              m0.address
		.m0_burstcount           (niose_input_in_csr_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (niose_input_in_csr_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (niose_input_in_csr_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (niose_input_in_csr_agent_m0_lock),                    //                .lock
		.m0_readdata             (niose_input_in_csr_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (niose_input_in_csr_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (niose_input_in_csr_agent_m0_read),                    //                .read
		.m0_waitrequest          (niose_input_in_csr_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (niose_input_in_csr_agent_m0_writedata),               //                .writedata
		.m0_write                (niose_input_in_csr_agent_m0_write),                   //                .write
		.rp_endofpacket          (niose_input_in_csr_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (niose_input_in_csr_agent_rp_ready),                   //                .ready
		.rp_valid                (niose_input_in_csr_agent_rp_valid),                   //                .valid
		.rp_data                 (niose_input_in_csr_agent_rp_data),                    //                .data
		.rp_startofpacket        (niose_input_in_csr_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (niose_input_in_csr_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (niose_input_in_csr_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (niose_input_in_csr_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (niose_input_in_csr_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (niose_input_in_csr_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (niose_input_in_csr_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (niose_input_in_csr_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (niose_input_in_csr_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (niose_input_in_csr_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (niose_input_in_csr_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (niose_input_in_csr_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (niose_input_in_csr_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (niose_input_in_csr_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) niose_input_in_csr_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                       //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.in_data           (niose_input_in_csr_agent_rf_source_data),             //        in.data
		.in_valid          (niose_input_in_csr_agent_rf_source_valid),            //          .valid
		.in_ready          (niose_input_in_csr_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (niose_input_in_csr_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (niose_input_in_csr_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (niose_input_in_csr_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (niose_input_in_csr_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (niose_input_in_csr_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (niose_input_in_csr_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (niose_input_in_csr_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) niose_input_out_agent (
		.clk                     (clk_0_clk_clk),                                    //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
		.m0_address              (niose_input_out_agent_m0_address),                 //              m0.address
		.m0_burstcount           (niose_input_out_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (niose_input_out_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (niose_input_out_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (niose_input_out_agent_m0_lock),                    //                .lock
		.m0_readdata             (niose_input_out_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (niose_input_out_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (niose_input_out_agent_m0_read),                    //                .read
		.m0_waitrequest          (niose_input_out_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (niose_input_out_agent_m0_writedata),               //                .writedata
		.m0_write                (niose_input_out_agent_m0_write),                   //                .write
		.rp_endofpacket          (niose_input_out_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (niose_input_out_agent_rp_ready),                   //                .ready
		.rp_valid                (niose_input_out_agent_rp_valid),                   //                .valid
		.rp_data                 (niose_input_out_agent_rp_data),                    //                .data
		.rp_startofpacket        (niose_input_out_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (niose_input_out_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (niose_input_out_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (niose_input_out_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (niose_input_out_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (niose_input_out_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (niose_input_out_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (niose_input_out_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (niose_input_out_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (niose_input_out_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (niose_input_out_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),                // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),                //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),                 //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),                //                .error
		.rdata_fifo_src_ready    (niose_input_out_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (niose_input_out_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (niose_input_out_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                            //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                              //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) niose_input_out_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                    //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (niose_input_out_agent_rf_source_data),             //        in.data
		.in_valid          (niose_input_out_agent_rf_source_valid),            //          .valid
		.in_ready          (niose_input_out_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (niose_input_out_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (niose_input_out_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (niose_input_out_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (niose_input_out_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (niose_input_out_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (niose_input_out_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (niose_input_out_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	nios_systemqsys_mm_interconnect_0_router router (
	...
	nios_systemqsys_mm_interconnect_0_router_001 router_001 (
	...
	nios_systemqsys_mm_interconnect_0_router_002 router_002 (
	...
	nios_systemqsys_mm_interconnect_0_router_002 router_003 (
	...
	nios_systemqsys_mm_interconnect_0_router_004 router_004 (
		.sink_ready         (nios_output_in_agent_rp_ready),                  //      sink.ready
		.sink_valid         (nios_output_in_agent_rp_valid),                  //          .valid
		.sink_data          (nios_output_in_agent_rp_data),                   //          .data
		.sink_startofpacket (nios_output_in_agent_rp_startofpacket),          //          .startofpacket
		.sink_endofpacket   (nios_output_in_agent_rp_endofpacket),            //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_systemqsys_mm_interconnect_0_router_004 router_005 (
		.sink_ready         (nios_output_in_csr_agent_rp_ready),              //      sink.ready
		.sink_valid         (nios_output_in_csr_agent_rp_valid),              //          .valid
		.sink_data          (nios_output_in_csr_agent_rp_data),               //          .data
		.sink_startofpacket (nios_output_in_csr_agent_rp_startofpacket),      //          .startofpacket
		.sink_endofpacket   (nios_output_in_csr_agent_rp_endofpacket),        //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_systemqsys_mm_interconnect_0_router_004 router_006 (
		.sink_ready         (niose_input_in_csr_agent_rp_ready),              //      sink.ready
		.sink_valid         (niose_input_in_csr_agent_rp_valid),              //          .valid
		.sink_data          (niose_input_in_csr_agent_rp_data),               //          .data
		.sink_startofpacket (niose_input_in_csr_agent_rp_startofpacket),      //          .startofpacket
		.sink_endofpacket   (niose_input_in_csr_agent_rp_endofpacket),        //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_systemqsys_mm_interconnect_0_router_004 router_007 (
		.sink_ready         (niose_input_out_agent_rp_ready),                 //      sink.ready
		.sink_valid         (niose_input_out_agent_rp_valid),                 //          .valid
		.sink_data          (niose_input_out_agent_rp_data),                  //          .data
		.sink_startofpacket (niose_input_out_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (niose_input_out_agent_rp_endofpacket),           //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_systemqsys_mm_interconnect_0_router_002 router_008 (
	...
	nios_systemqsys_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_systemqsys_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_systemqsys_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_systemqsys_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_systemqsys_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_systemqsys_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_systemqsys_mm_interconnect_0_cmd_mux_002 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_systemqsys_mm_interconnect_0_cmd_mux_002 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_systemqsys_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_systemqsys_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_systemqsys_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_systemqsys_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_systemqsys_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_systemqsys_mm_interconnect_0_rsp_demux_002 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_systemqsys_mm_interconnect_0_rsp_demux_002 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_systemqsys_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_systemqsys_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_systemqsys_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_systemqsys_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	nios_systemqsys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (nios_output_in_agent_rdata_fifo_src_data),       //     in_0.data
		.in_0_valid     (nios_output_in_agent_rdata_fifo_src_valid),      //         .valid
		.in_0_ready     (nios_output_in_agent_rdata_fifo_src_ready),      //         .ready
	...
	nios_systemqsys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (nios_output_in_csr_agent_rdata_fifo_src_data),   //     in_0.data
		.in_0_valid     (nios_output_in_csr_agent_rdata_fifo_src_valid),  //         .valid
		.in_0_ready     (nios_output_in_csr_agent_rdata_fifo_src_ready),  //         .ready
	...
	nios_systemqsys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (niose_input_in_csr_agent_rdata_fifo_src_data),   //     in_0.data
		.in_0_valid     (niose_input_in_csr_agent_rdata_fifo_src_valid),  //         .valid
		.in_0_ready     (niose_input_in_csr_agent_rdata_fifo_src_ready),  //         .ready
	...
	nios_systemqsys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (niose_input_out_agent_rdata_fifo_src_data),      //     in_0.data
		.in_0_valid     (niose_input_out_agent_rdata_fifo_src_valid),     //         .valid
		.in_0_ready     (niose_input_out_agent_rdata_fifo_src_ready),     //         .ready
