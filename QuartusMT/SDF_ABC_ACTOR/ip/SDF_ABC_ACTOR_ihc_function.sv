...
module SDF_ABC_ACTOR_ihc_function (
    ...
    SDF_ABC_ACTOR_i_llvm_fpga_pipeline_keep_going_ihc2_sr thei_llvm_fpga_pipeline_keep_going_ihc2_sr (
        .in_i_data(GND_q),
    ...
    SDF_ABC_ACTOR_arbiter_iowr_s4 thearbiter_iowr_s4 (
    ...
    SDF_ABC_ACTOR_arbiter_iord_s1 thearbiter_iord_s1 (
    ...
    SDF_ABC_ACTOR_bb_ihc_B1 thebb_ihc_B1 (
        .in_forked_0(GND_q),
    ...
    SDF_ABC_ACTOR_bb_ihc_B0 thebb_ihc_B0 (
    ...
    SDF_ABC_ACTOR_bb_ihc_B1_sr_1 thebb_ihc_B1_sr_1_aunroll_x (
